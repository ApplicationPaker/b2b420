...
class _HomeScreenState extends State<HomeScreen>
    with Utility, MessagingMixin, NavigationMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        ...
        SplashScreen(loading: widget.store!.loading, color: Colors.black),
      ],
    );
  }
  ...
  Widget buildHome(DataScreen? data) {
    ...
    extraScreens.forEach((key, value) {
      newWidgetOptions.putIfAbsent(
          "extraScreens_$key", () => CustomScreen(screenKey: key));
    });
    ...
    double widthStyle =
        MediaQuery.of(context).size.width * (isRTL ? 0.65 : 0.83);
