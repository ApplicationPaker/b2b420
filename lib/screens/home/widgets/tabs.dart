...
class _TabsState extends State<Tabs> with Utility {
  ...
  Widget build(BuildContext context) {
    ...
    Color background =
    ConvertData.fromRGBA(get(configStyle, ['background', themeModeKey], {}), theme.bottomAppBarColor);

    Color textColor = ConvertData.fromRGBA(get(configStyle, ['color', themeModeKey], {}), Colors.black);

    Color activeColor =
    ConvertData.fromRGBA(get(configStyle, ['colorActive', themeModeKey], {}), theme.primaryColor);
