...
class Item extends StatefulWidget {
  ...
  final Function(BuildContext context, CartItem cartItem, int value)
      updateQuantity;
...
class _ItemState extends State<Item>
  ...
  Future<void> onChanged(int value) async {
    ...
    timer = Timer(Duration(milliseconds: milliseconds),
        () => widget.updateQuantity(context, widget.cartItem, value));
  }
  ...
  void _navigate(SettingStore settingStore) {
    int id = widget.cartItem.id as int;
