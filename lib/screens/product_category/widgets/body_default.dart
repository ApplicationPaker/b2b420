...
class DefaultCategory extends StatelessWidget with LoadingMixin, Utility {
  ...
  Widget build(BuildContext context) {
    ...
    Data? data = Provider.of<SettingStore>(context).data!.screens!['home'];
    Widget? appBar = buildHomeAppBar(context, data: data!);
  ...
  Widget? buildBanner(BuildContext context,
    ...
    return SliverPadding(
      padding: paddingHorizontal.copyWith(bottom: itemPaddingMedium, top: 20),
