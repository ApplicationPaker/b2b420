  ...
  Widget build(BuildContext context) {
    ...
    return Chat(
      ...
      theme: DefaultChatTheme(
        ...
        sentMessageCaptionTextStyle: theme.textTheme.titleSmall!.copyWith(color: Colors.white),
        sentMessageBodyTextStyle: theme.textTheme.bodyMedium!.copyWith(color: Colors.white),
        sentMessageLinkTitleTextStyle: theme.textTheme.titleMedium!.copyWith(color: Colors.white),
        sentMessageLinkDescriptionTextStyle: theme.textTheme.bodyMedium!.copyWith(color: Colors.white),
        receivedMessageBodyTextStyle: theme.textTheme.bodyMedium!.copyWith(color: theme.textTheme.titleMedium?.color),
        receivedMessageCaptionTextStyle: theme.textTheme.titleSmall!,
        receivedMessageLinkDescriptionTextStyle:
            theme.textTheme.bodyMedium!.copyWith(color: theme.textTheme.titleMedium?.color),
        receivedMessageLinkTitleTextStyle: theme.textTheme.titleMedium!,
        dateDividerTextStyle: theme.textTheme.bodySmall!,
        emptyChatPlaceholderTextStyle: theme.textTheme.bodySmall!,
        inputContainerDecoration: BoxDecoration(
          color: theme.colorScheme.surface,
          borderRadius: borderRadiusBottomSheetLarge,
        ),
        inputTextColor: theme.textTheme.titleMedium!.color!,
