...
mixin MessagingMixin<T extends StatefulWidget> on State<T> {
  Future<void> subscribe(RequestHelper requestHelper, Function navigate) async {
    ...
    FirebaseMessaging.instance.onTokenRefresh
        .listen((token) => updateTokenToDatabase(requestHelper, token));
    ...
    FirebaseMessaging.onMessageOpenedApp
        .listen((RemoteMessage message) => _handleMessage(message, navigate));
...
Future<ByteArrayAndroidBitmap?> getAndroidBitmapFromUrl(
  ...
  try {
    Response res = await dio.get(notification.android!.imageUrl!,
